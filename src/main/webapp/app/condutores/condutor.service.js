(function(){
  ...
  function CondutorService($http) {
    ...
    function findAllOver() {
      return $http.get('http://localhost:8080/api/condutores/all?order=descricao')
    ...
    function findAll(filtro, page) {
      return $http.get('http://localhost:8080/api/condutores?page=' + page.number
    ...
    function findById(id) {
      return $http.get('http://localhost:8080/api/condutores/' + id)
        .then(function (response) {
          return response.data;
        });
    }
    ...
    function insert(registro) {
      return $http.post('http://localhost:8080/api/condutores', registro)
        .then(function (response) {
          return response.data;
        });
    }
    ...
    function update(registro) {
      return $http.put('http://localhost:8080/api/condutores/' + registro.id, registro)
        .then(function (response) {
          return response.data;
        });
    }
    ...
    function remove(id) {
      return $http.delete('http://localhost:8080/api/condutores/' + id)
        .then(function (response) {
          return response.data;
        });
    }
